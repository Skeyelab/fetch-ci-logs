...
describe('Utility Functions', () => {
  ...
  describe('autodetectRepo', () => {
    ...
    test('should parse SSH git URL', async () => {
      // Mock execSync to return SSH URL
      const originalExecSync = require('child_process').execSync;
      require('child_process').execSync = jest.fn(() => 'git@github.com:owner/repo.git');
    ...
    test('should parse HTTPS git URL', async () => {
      // Mock execSync to return HTTPS URL
      const originalExecSync = require('child_process').execSync;
      require('child_process').execSync = jest.fn(() => 'https://github.com/owner/repo.git');
